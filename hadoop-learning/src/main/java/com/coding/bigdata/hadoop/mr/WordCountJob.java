 ...
 *
 * Window环境执行方式：直接执行
 * Linux环境执行方式：hadoop jar ~/bigdata/hadoop/lib/hadoop-learning-1.0-SNAPSHOT-jar-with-dependencies.jar com.coding.bigdata.hadoop.mr.WordCountJob /custom/data/mr/normal/input/hello.txt /custom/data/mr/normal/output
 */
@Slf4j
public class WordCountJob {
    ...
    public static void main(String[] args) {
        ...
        try {
            ...
            log.error(WordCountJob.class.getSimpleName(), e);
        }
    }
