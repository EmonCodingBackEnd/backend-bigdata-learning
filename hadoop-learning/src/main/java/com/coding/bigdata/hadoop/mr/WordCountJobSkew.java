...
/*
 * 需求：数据倾斜-增加Reduce任务个数
 *
 * Window环境执行方式：直接执行
 * Linux环境执行方式：hadoop jar ~/bigdata/hadoop/lib/hadoop-learning-1.0-SNAPSHOT-jar-with-dependencies.jar com.coding.bigdata.hadoop.mr.WordCountJobSkew /custom/data/mr/skew/input/hello_10000000.dat /custom/data/mr/normal/output 10
 */
@Slf4j
public class WordCountJobSkew {
    ...
    public static void main(String[] args) {
        ...
        try {
            ...
            log.error(WordCountJobSkew.class.getSimpleName(), e);
        }
    }
