...
hive -e "
insert overwrite table app_warehousedb.app_user_conver_funnel partition(dt='${dt}')  select
duah.active_num,
dgi.item_num,
duo.order_num,
duo.pay_num,
...
(
    ...
    from dwd_warehousedb.dwd_good_item
    where dt = '${dt}'
)as dgi
on 1=1
join
(
    ...
    from dwd_warehousedb.dwd_user_order
    where dt = '${dt}'
) as duo
on 1=1;
"
