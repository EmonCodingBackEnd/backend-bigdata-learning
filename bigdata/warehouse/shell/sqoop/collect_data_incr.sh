...
echo "开始采集..."
echo "采集表：user_order"
sh /home/emon/bigdata/warehouse/shell/sqoop/sqoop_collect_data_util.sh "${user_order_sql}" "${user_order_path}"
echo "采集表：order_item"
sh /home/emon/bigdata/warehouse/shell/sqoop/sqoop_collect_data_util.sh "${order_item_sql}" "${order_item_path}"
echo "采集表：order_delivery"
sh /home/emon/bigdata/warehouse/shell/sqoop/sqoop_collect_data_util.sh "${order_delivery_sql}" "${order_delivery_path}"
echo "采集表：payment_flow"
sh /home/emon/bigdata/warehouse/shell/sqoop/sqoop_collect_data_util.sh "${payment_flow_sql}" "${payment_flow_path}"
