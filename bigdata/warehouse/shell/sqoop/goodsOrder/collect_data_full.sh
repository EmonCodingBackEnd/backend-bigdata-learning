...
echo "开始采集..."
echo "采集表：user"
sh /home/emon/bigdata/warehouse/shell/sqoop/goodsOrder/sqoop_collect_data_util.sh "${user_sql}" "${user_path}"
echo "采集表：user_extend"
sh /home/emon/bigdata/warehouse/shell/sqoop/goodsOrder/sqoop_collect_data_util.sh "${user_extend_sql}" "${user_extend_path}"
echo "采集表：user_addr"
sh /home/emon/bigdata/warehouse/shell/sqoop/goodsOrder/sqoop_collect_data_util.sh "${user_addr_sql}" "${user_addr_path}"
echo "采集表：goods_info"
sh /home/emon/bigdata/warehouse/shell/sqoop/goodsOrder/sqoop_collect_data_util.sh "${goods_info_sql}" "${goods_info_path}"
echo "采集表：category_code"
sh /home/emon/bigdata/warehouse/shell/sqoop/goodsOrder/sqoop_collect_data_util.sh "${category_code_sql}" "${category_code_path}"
