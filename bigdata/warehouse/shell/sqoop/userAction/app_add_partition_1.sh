...
hive -e "
insert overwrite table app_warehousedb.app_user_new_count partition(dt='${dt}') select
count(*) as num
from dws_warehousedb.dws_user_new_item
where dt = '${dt}';

insert overwrite table app_warehousedb.app_user_new_count_ratio partition(dt='${dt}') select
num,
...
from(
    ...
    from app_warehousedb.app_user_new_count
