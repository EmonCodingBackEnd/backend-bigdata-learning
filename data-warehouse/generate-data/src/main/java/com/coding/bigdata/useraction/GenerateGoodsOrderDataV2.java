...
/** 需求：生成商品订单相关数据(服务端数据) 生成2026-02-01~2026-02-28的数据 Created by xuwei */
public class GenerateGoodsOrderDataV2 {
    private static final Logger logger = LoggerFactory.getLogger(GenerateGoodsOrderDataV2.class);
    ...
    public static void main(String[] args) throws Exception {
        ...
        if (!flag) {
            ...
            String[] tableArr = GenerateDateAndActArrUtils.getTableArr();
